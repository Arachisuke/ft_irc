...
/*   Updated: 2025/09/15 14:39:51 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
    ...
    for (size_t i = 0; i < list.size(); i++)
    {
        if (list[i][0] == '#')
        {
           ...
           if (!this->_channeList[n]->isMember(this->_clientList[this->_nbrclient]))
              continue ;
           std::string msg = ":" + this-> _clientList[this->_nbrclient]->getNickname() + "!" + this->_clientList[this->_nbrclient]->getUsername() + "@localhost" + " NOTICE " + this->_channeList[n]->getName() + " : ";
        ...
        else // client
        {
            ...
            std::string msg = ":" + this-> _clientList[this->_nbrclient]->getNickname() + "!" + this->_clientList[this->_nbrclient]->getUsername() + "@localhost" + " NOTICE " + this->_clientList[n]->getNickname() + " : ";
            for (size_t i = 2; i < this->_cmd.size(); i++)
                    msg += this->_cmd[i] + " ";
                msg += "\r\n";
